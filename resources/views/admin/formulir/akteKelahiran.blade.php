            ...
            <table id="datatablesSimple">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-1">
                            <a href="{{ url('admin/formulir-masuk/akte-kelahiran/'.$dt->id) }}" class="badge bg-info"><i class="fas fa-eye"></i></a>
                            <a href="#" class="badge bg-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-url="{{ url('/admin/formulir-masuk/akte-kelahiran/'.$dt->id) }}"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
